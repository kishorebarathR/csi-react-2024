      ...
      <div className=" lg:mt-24 mt-72 lg:px-10  ">
        ...
        <div className="font16px lg:px-0 px-3">
          ...
          <p className="mt-3">
            ...
            August 1 and 2, 2024in New Delhi to craft an inclusive and
            transformative path towards 2047 - India at 100 | Viksit Bharat
            @2047 the vision to make India a developed nation by 2047, the 100th
